...
_STATUS_MAP: dict[str, int] = {
    ...
    # WI-330 estate cutover catalog (§4.3). Also offline-only — the catalog is built,
    # signed and verified by the CLI and the sidecar exposes no catalog endpoint — so
    # these mappings exist to satisfy total coverage. Both are defects in the
