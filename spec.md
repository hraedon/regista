...
- Transparency-log anchoring of the event log to an external append-only log (Bitcoin via OpenTimestamps, RFC 3161 TSA, or operator-controlled file) — **implemented (FR-30)**
