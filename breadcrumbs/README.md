...
| 314 | trigger_timestamping holds DB transaction open during 30s HTTP call to TSA | high | proposed |
| 315 | No recovery sweep for stuck in_progress witness receipts | high | proposed |
...
| 196 | HMAC signing is symmetric — no external/adversarial verifiability | medium | Implemented — Plan 011 added SigningScheme protocol with HMACSHA256Scheme + Ed25519Scheme, scheme_id discriminator on events (migration 015), and full sign/verify/key-rotation parity. BC-216/BC-217 landed simultaneously. Spec and positioning updates remain open. |
