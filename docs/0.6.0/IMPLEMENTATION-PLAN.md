...
> found 167 of the manifest's 694 nodes are blocked by the **in-memory backend's** epoch
...
> Postgres-blocked population (694 − 167), WI-287 the C3/in-memory tranche (167). The
