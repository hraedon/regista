...
[![Tests](https://img.shields.io/badge/tests-1266%20passing-brightgreen)]()
...
All features through Plan 022 implemented. 1266 tests passing (core, sidecar, property-based, witness, timestamping, and plan-specific). FR-01 through FR-29 in tree. 310 breadcrumbs tracked, 305 resolved. See `AGENTS.md` for detailed status.
